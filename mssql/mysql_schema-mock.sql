...
CREATE TABLE IF NOT EXISTS `Account` (
  ...
  `dateCreated` DATE DEFAULT NULL COMMENT 'ISO 6801 date when the account was created',
  `dateOpened` DATE DEFAULT NULL COMMENT 'ISO 6801 date when the account was opened or activated',
  `dateLastUpdated` DATE DEFAULT NULL COMMENT 'ISO 6801 date when the account was last updated',
  `dateClosed` DATE DEFAULT NULL COMMENT 'ISO 6801 date when the account was closed or deactivated',
