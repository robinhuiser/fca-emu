...
func (*Bank) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case bank.FieldBankCode, bank.FieldBankName, bank.FieldURL, bank.FieldSwift:
...
func (b *Bank) assignValues(columns []string, values []interface{}) error {
	...
	for i := range columns {
		...
		case bank.FieldSwift:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field swift", values[i])
			} else if value.Valid {
				b.Swift = value.String
			}
		}
	}
	return nil
...
func (b *Bank) QueryBranches() *BranchQuery {
	return (&BankClient{config: b.config}).QueryBranches(b)
}
...
func (b *Bank) String() string {
	...
	builder.WriteString(b.BankCode)
	builder.WriteString(", bankName=")
	builder.WriteString(b.BankName)
	builder.WriteString(", url=")
	builder.WriteString(b.URL)
	builder.WriteString(", swift=")
	builder.WriteString(b.Swift)
	builder.WriteByte(')')
