...
func (bid *BinaryItemDelete) Where(ps ...predicate.BinaryItem) *BinaryItemDelete {
...
func (bid *BinaryItemDelete) sqlExec(ctx context.Context) (int, error) {
...
func (bido *BinaryItemDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{binaryitem.Label}
	default:
		return nil
	}
}
